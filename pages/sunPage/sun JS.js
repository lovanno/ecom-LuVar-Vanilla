/*Framework  -  What's needed initially will located here. As sections are created, they will be organized by querySelectors, functions, and loops
Some querySelectors or Arrays will be right above loops for readability. Search sections by name, number (Section X), or modal (Modal X)  -    
...
/**     navBar (Section 1)  +  sideBar (Section 3)    -  (Shared)       **/         
        ...
        window.addEventListener('scroll', function(){            /*  navBar (Section 1) - addEventListener     */
                ...
                pDescTabBtn[j].addEventListener("click", function() {
                    ...
                    if(pDescTabBtn[0].style.backgroundColor == "black"){
                        ...
                        if(mediaQ1.matches){                                                            /*Used to make Q1 (1250px) look good*/   
                            moveDescHeader.style.right = "16%";
                        }
                        else {
                            moveDescHeader.style.right = "30%";
                        }
                        ...
                        if(mediaQ1.matches){        
                            moveDescHeader.style.right = "18.80%";            
                        }
                        else{
                            moveDescHeader.style.right = "33.8%";
                        }
                        ...
                        if(mediaQ1.matches){        
                            moveDescHeader.style.right = "19.75%";            
                        }
                        else{
                            moveDescHeader.style.right = "36%";
                        }
        ...
        for(let m=0; m<descBtn.length; m++){
            ...
            descBtn[m].addEventListener("click", function(){  
                ...
                if(m < 8){
                    ...
                    if(mediaQ1.matches){                                                                /*Used to make Q1 (1250px) look good*/            
                        prodDescStyle(0, m, "16%");
                    }
                    else {
                        prodDescStyle(0, m, "30%");
                    }
                    ...
                    if(mediaQ1.matches){                                                                /*Used to make Q1 (1250px) look good*/            
                        prodDescStyle(1, (m-8), "18.80%");
                    }
                    else {
                        prodDescStyle(1, (m-8), "33.8%");
                    }
                    ...
                    if(mediaQ1.matches){                                                                /*Used to make Q1 (1250px) look good*/            
                        prodDescStyle(2, (m-16), "19.75%");
                    }
                    else {
                        prodDescStyle(2, (m-16), "36%");
                    }
...
try {
        ...
        clearCart.addEventListener("click", function() {
            ...
            event.cancelBubble = true;          /*our winner here. Stops once it gets to children. */
